...
#include "tf_adapter/kernels/aicore/dynamic_augru_ops.cc"
...
TEST(DynamicAUGRUOpTest, TestDynamicAUGRU) {
  DataTypeSlice input_types(
      {DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_FLOAT, DT_INT32, DT_FLOAT});
