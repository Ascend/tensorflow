...
#include "tf_adapter/kernels/aicore/dynamic_rnn_grad_ops.cc"
...
TEST(DynamicRnnGradOpTest, TestDynamicRnnGradShapeInference) {
  const OpRegistrationData *reg;
  TF_CHECK_OK(OpRegistry::Global()->LookUp("DynamicRnnGrad", &reg));
