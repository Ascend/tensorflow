...
#ifndef NPU_DEVICE_CORE_OP_EXECUTORS_NPU_RESOURCE_GENERATOR_OP_H
#define NPU_DEVICE_CORE_OP_EXECUTORS_NPU_RESOURCE_GENERATOR_OP_H

#include "npu_op_executor.h"
#include "npu_concrete_graph.h"

namespace npu {
class NpuResourceGeneratorOp : public OpExecutor {
  using HashKey = uint64_t;

 public:
  NpuResourceGeneratorOp(const tensorflow::OpRegistrationData *op_spec, const tensorflow::NodeDef &ndef,
...
#endif  // NPU_DEVICE_CORE_OP_EXECUTORS_NPU_RESOURCE_GENERATOR_OP_H
